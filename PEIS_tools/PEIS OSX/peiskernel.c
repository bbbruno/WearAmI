...
void peisk_initialize(int *argc,char **args) {
  ...
  */
  ...
  peisk_printLevel = 1; /* PEISK_PRINT_STATUS | PEISK_PRINT_CONNECTIONS; */ /* MB - was 0 */
  ...
  snprintf(tmp,sizeof(tmp),"v%s (proto %d)","1.0",peisk_protocollVersion);
