...
JNIEXPORT void JNICALL Java_com_andrea_wearami_MainActivity_peis_1init
        (JNIEnv *env, jobject obj){
  char args[0]="a";
  peiskmt_initialize(0,args);
}

JNIEXPORT void JNICALL Java_com_andrea_wearami_MainActivity_peis_1setTuple
...
JNIEXPORT jstring JNICALL Java_com_andrea_wearami_MainActivity_peis_1getTuple
...
JNIEXPORT jstring JNICALL Java_com_andrea_wearami_MainActivity_peis_1getTupleByAbstract
